...
const Footer = () => {
  return (
    <div className="max-w-[1640px] h-[300px] mx-auto w-full p-4 py-12 grid md:flex md:items-center md:justify-evenly grid-cols-5 whitespace-nowrap bg-gray-100">
      ...
      <MdRestaurantMenu className='hover:animate-ping text-5xl'/>
        ...
        <div className='flex items-center gap-6  '>
         ...
         <div className='flex items-center flex-col space-y-4'>
           <p className='font-semibold sm:text-xl md:text-2xl'>Contact </p>
         ...
         <div className='flex items-center flex-col space-y-4'>
           <p className='font-semibold sm:text-xl md:text-2xl'>Support </p>
        ...
        <div className='flex items-center flex-col space-y-4'>
          <p className='font-semibold sm:text-xl md:text-2xl '>Refer </p>
